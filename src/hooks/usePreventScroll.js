...
function isIPad() {
  return (// iPadOS 13 lies and says it's a Mac, but we can distinguish by detecting touch support.
...
function preventScrollMobileSafari() {
  ...
  let restoreStyles = chain(// setStyle(document.documentElement, 'overflow', 'hidden'),
